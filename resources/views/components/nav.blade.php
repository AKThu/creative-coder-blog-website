<nav class="bg-primary-background drop-shadow-lg-blue sticky top-0 z-50">
    <div class="max-w-screen-xl flex flex-row items-center mx-auto p-4">
        ...
        <div class="absolute left-1/2 -translate-x-1/2">
            <ul class="w-fit text-lg font-medium flex flex-row gap-x-6 p-4 text-white">
                <li>
                    <a href="/" class="hover:text-lightblue1">Home</a>
                </li>
                <li>
                    <a href="/#blogs" class="hover:text-lightblue1">Blogs</a>
                </li>
            </ul>
        </div>
</nav>
