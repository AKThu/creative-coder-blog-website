...
<div
     class="group flex flex-col justify-between bg-primary-background ring-1 hover:ring ring-lightblue1 text-white hover:drop-shadow-md rounded-lg w-full sm:w-3/5 lg:w-2/5 2xl:w-1/4 min-h-fit py-6 px-6">
